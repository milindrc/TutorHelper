...
public class ADD3Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        B.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    AlertDialog ad =  new AlertDialog.Builder(ADD3Activity.this).create();
    ...
    class myWidth implements View.OnLayoutChangeListener
    {
        int index;
    ...
    class inputDate implements View.OnClickListener
    {
        ...
        public void onClick(final View v) {
            ...
            DatePickerDialog dpd = new DatePickerDialog(ADD3Activity.this, new DatePickerDialog.OnDateSetListener() {
    ...
    class inputFeeType implements View.OnClickListener
    {
        ...
        public void onClick(View v) {
            ...
            final AlertDialog.Builder Build =  new AlertDialog.Builder(ADD3Activity.this);
            ...
            final ArrayAdapter<String> aa = new ArrayAdapter<String>(ADD3Activity.this, android.R.layout.select_dialog_singlechoice);
            aa.add("Monthly");
            aa.add("Quaterly");
            aa.add("Half-Yearly");
            aa.add("Annually");
